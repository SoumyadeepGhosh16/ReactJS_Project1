...
function Footer() {
  return (
    <div className="flex gap-5 w-full h-screen bg-zinc-900 p-20">
        <div className="w-1/2 h-full flex flex-col justify-between font-['Oswald']">
            <div className="heading">
               <h1 className="text-[6vw] font-medium uppercase leading-none -mb-15">
                  Eye-
                </h1>
               <h1 className="text-[6vw] font-medium uppercase leading-none -mb-15">
                  Opening
        ...
        <div className="w-1/2 ">
            <h1 className="text-[6vw] font-medium uppercase leading-none -mb-15 font-['Oswald']">
                  Presentations
            </h1>

                  <div className="dets mt-10 font-['Roboto']">
                     <a className="block text-md font-light pb-5" href="#">S:</a>
                     <a className="block text-md  underlinefont-light underline" href="#">Facebook</a>
                     <a className="block text-md font-light underline" href="#">Instagram</a>
                     <a className="block text-md font-light underline" href="#">Behance</a>
                     <a className="block text-md font-light underline" href="#">Linkedin</a>
                  </div>
        </div>
    </div>
  )
